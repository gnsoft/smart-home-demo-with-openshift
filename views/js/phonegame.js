 ...
 *
 * When no arguments are delivered, all classes defined in phonegame.js as well as all classes defined in
 * plugins will be exported. When more than one argument is delivered, by default only classes defined
 * in phonegame.js will be exported. When you wish to export plugin classes you must explicitly deliver  *  * plugin identifiers as arguments.
 *
 * @example
 *   phonegame();     // All classes will be exported.
 *   phonegame('');   // Only classes in phonegame.js will be exported.
 *   phonegame('ui'); // phonegame.js classes and ui.phonegame.js classes will be exported.
 *
 * @param {...String} [modules] Export module. Multiple designations possible.
 */
var phonegame = function(modules) {
    if (modules != null) {
...
window.addEventListener("message", function(msg, origin) {
    try {
        ...
        if (data.type === "event") {
            phonegame.Game.instance.dispatchEvent(new phonegame.Event(data.value));
        } else if (data.type === "debug") {
            switch (data.value) {
                case "start":
                    phonegame.Game.instance.start();
                    break;
                case "pause":
                    phonegame.Game.instance.pause();
                    break;
                case "resume":
                    phonegame.Game.instance.resume();
                    break;
                case "tick":
                    phonegame.Game.instance._tick();
                    break;
                default:
                    break;
            }
 ...
 * @constructor
 */
phonegame.Class = function(superclass, definition) {
    return phonegame.Class.create(superclass, definition);
};
 ...
 * @static
 */
phonegame.Class.create = function(superclass, definition) {
    if (arguments.length === 0) {
        return phonegame.Class.create(Object, definition);
    } else if (arguments.length === 1 && typeof arguments[0] !== 'function') {
        return phonegame.Class.create(Object, arguments[0]);
    }
...
/**
 * @scope phonegame.Event.prototype
 */
phonegame.Event = phonegame.Class.create({
    /**
    ...
    _initPosition: function(pageX, pageY) {
        var game = phonegame.Game.instance;
 ...
 * @type {String}
 */
phonegame.Event.LOAD = 'load';

/**
 * Events occurring during game loading.
 * Activated each time a preloaded image is loaded. Issued object: phonegame.Game
 * @type {String}
 */
phonegame.Event.PROGRESS = 'progress';

/**
 * Events occurring during frame start.
 * Issued object: phonegame.Game, phonegame.Node
 * @type {String}
 */
phonegame.Event.ENTER_FRAME = 'enterframe';
 ...
 * @type {String}
 */
phonegame.Event.EXIT_FRAME = 'exitframe';

/**
 * Events occurring during Scene beginning.
 * Issued object: phonegame.Scene
 * @type {String}
 */
phonegame.Event.ENTER = 'enter';
 ...
 * @type {String}
 */
phonegame.Event.EXIT = 'exit';

/**
 * Event occurring when Node is added to Group.
 * Issued object: phonegame.Node
 * @type {String}
 */
phonegame.Event.ADDED = 'added';
 ...
 * @type {String}
 */
phonegame.Event.ADDED_TO_SCENE = 'addedtoscene';
 ...
 * @type {String}
 */
phonegame.Event.REMOVED = 'removed';
 ...
 * @type {String}
 */
phonegame.Event.REMOVED_FROM_SCENE = 'removedfromscene';

/**
 * Event occurring when touch corresponding to Node has begun.
 * Click is also treated as touch. Issued object: phonegame.Node
 * @type {String}
 */
phonegame.Event.TOUCH_START = 'touchstart';
 ...
 * @type {String}
 */
phonegame.Event.TOUCH_MOVE = 'touchmove';
 ...
 * @type {String}
 */
phonegame.Event.TOUCH_END = 'touchend';

/**
 * Event occurring when Entity is rendered.
 * Issued object: phonegame.Entity
 * @type {String}
 */
phonegame.Event.RENDER = 'render';

/**
 * Event occurring when button is pushed.
 * Issued object: phonegame.Game, phonegame.Scene
 * @type {String}
 */
phonegame.Event.INPUT_START = 'inputstart';
 ...
 * @type {String}
 */
phonegame.Event.INPUT_CHANGE = 'inputchange';
 ...
 * @type {String}
 */
phonegame.Event.INPUT_END = 'inputend';
 ...
 * @type {String}
 */
phonegame.Event.LEFT_BUTTON_DOWN = 'leftbuttondown';
 ...
 * @type {String}
 */
phonegame.Event.LEFT_BUTTON_UP = 'leftbuttonup';
 ...
 * @type {String}
 */
phonegame.Event.RIGHT_BUTTON_DOWN = 'rightbuttondown';
 ...
 * @type {String}
 */
phonegame.Event.RIGHT_BUTTON_UP = 'rightbuttonup';
 ...
 * @type {String}
 */
phonegame.Event.UP_BUTTON_DOWN = 'upbuttondown';
 ...
 * @type {String}
 */
phonegame.Event.UP_BUTTON_UP = 'upbuttonup';
 ...
 * @type {String}
 */
phonegame.Event.DOWN_BUTTON_DOWN = 'downbuttondown';
 ...
 * @type {String}
 */
phonegame.Event.DOWN_BUTTON_UP = 'downbuttonup';
 ...
 * @type {String}
 */
phonegame.Event.A_BUTTON_DOWN = 'abuttondown';
 ...
 * @type {String}
 */
phonegame.Event.A_BUTTON_UP = 'abuttonup';
 ...
 * @type {String}
 */
phonegame.Event.B_BUTTON_DOWN = 'bbuttondown';
 ...
 * @type {String}
 */
phonegame.Event.B_BUTTON_UP = 'bbuttonup';

/**
 * @scope phonegame.EventTarget.prototype
 */
phonegame.EventTarget = phonegame.Class.create({
    /**
     * A class for independent event implementation like DOM Events.
     * However, does not include phase concept.
     * @constructs
     ...
     * Add EventListener.
     * @param {String} type Event type.
     * @param {function(e:phonegame.Event)} listener EventListener added.
     */
     ...
     * @param {String} type Event type.
     * @param {function(e:phonegame.Event)} listener EventListener deleted.
     */
    ...
    /**
     * Issue event.
     * @param {phonegame.Event} e Event issued.
     */
...
/**
 * @scope phonegame.Game.prototype
 */
...
(function() {
     ...
     * @scope phonegame.Game.prototype
     */
    phonegame.Game = phonegame.Class.create(phonegame.EventTarget, {
        /**
        ...
        initialize: function(width, height) {
            ...
            phonegame.EventTarget.call(this);
            var initial = true;
            if (game) {
                initial = false;
                game.stop();
            }
            game = phonegame.Game.instance = this;
            ...
            var stage = document.getElementById('phonegame-stage');
            if (!stage) {
                stage = document.createElement('div');
                stage.id = 'phonegame-stage';
             ...
             * @type {phonegame.Scene}
             */
            this.rootScene = new phonegame.Scene();
            this.pushScene(this.rootScene);
            /**
             * Scene displayed during loading.
             * @type {phonegame.Scene}
             */
            this.loadingScene = new phonegame.Scene();
            ...
            var bar = new phonegame.Sprite(barWidth, barHeight);
            bar.x = (this.width - barWidth) / 2;
            bar.y = (this.height - barHeight) / 2;
            var image = new phonegame.Surface(barWidth, barHeight);
            ...
            ['left', 'right', 'up', 'down', 'a', 'b'].forEach(function(type) {
                this.addEventListener(type + 'buttondown', function(e) {
                    ...
                    if (!this.input[type]) {
                        ...
                        inputEvent = new phonegame.Event((c++) ? 'inputchange' : 'inputstart');
                ...
                this.addEventListener(type + 'buttonup', function(e) {
                    ...
                    if (this.input[type]) {
                        ...
                        inputEvent = new phonegame.Event((--c) ? 'inputchange' : 'inputend');
                        this.dispatchEvent(inputEvent);
                    }
                    this.currentScene.dispatchEvent(e);
                    if (inputEvent) {
            ...
            if (initial) {
                stage = phonegame.Game.instance._element;
                var evt;
                document.addEventListener('keydown', function(e) {
                    game.dispatchEvent(new phonegame.Event('keydown'));
                    ...
                    if (button) {
                        evt = new phonegame.Event(button + 'buttondown');
                ...
                document.addEventListener('keyup', function(e) {
                    ...
                    var button = game._keybind[e.keyCode];
                    if (button) {
                        evt = new phonegame.Event(button + 'buttonup');
                        game.dispatchEvent(evt);
                    }
                }, true);

                if (phonegame.ENV.TOUCH_ENABLED) {
                    stage.addEventListener('touchstart', function(e) {
                        var tagName = (e.target.tagName).toLowerCase();
                        if (phonegame.ENV.USE_DEFAULT_EVENT_TAGS.indexOf(tagName) === -1) {
                            e.preventDefault();
                            if (!game.running) {
                                e.stopPropagation();
                            }
         ...
         *
         * phonegame is a file set to execute preload. It is loaded when
         ...
         *
         * In addition, because this Surface object used made with phonegame.Surface.load,
         * direct object manipulation is not possible. Refer to the items of phonegame.Surface.load
         *
         * @example
         *   game.preload('player.gif');
         *   game.onload = function() {
        ...
        load: function(src, callback) {
            ...
            var ext = phonegame.Game.findExt(src);

            if (phonegame.Game._loadFuncs[ext]) {
                phonegame.Game._loadFuncs[ext].call(this, src, callback, ext);
            }
            else {
                ...
                req.onreadystatechange = function(e) {
                    if (req.readyState === 4) {
                        ...
                        if (type.match(/^image/)) {
                            game.assets[src] = phonegame.Surface.load(src);
                            game.assets[src].addEventListener('load', callback);
                        } else if (type.match(/^audio/)) {
                            game.assets[src] = phonegame.Sound.load(src, type);
                            game.assets[src].addEventListener('load', callback);
                        } else {
         ...
         * Begin game.
         *
         * Obeying the frame rate set in phonegame.Game#fps, the frame in
         * phonegame.Game#currentScene will be updated. When a preloaded image is present,
        ...
        start: function() {
            if (this._intervalID) {
                ...
                if (phonegame.Sound.enabledInMobileSafari && !game._touched &&
                    phonegame.ENV.VENDOR_PREFIX === 'webkit' && phonegame.ENV.TOUCH_ENABLED) {
                    var scene = new phonegame.Scene();
                    scene.backgroundColor = '#000';
                    var size = Math.round(game.width / 10);
                    var sprite = new phonegame.Sprite(game.width, size);
                    sprite.y = (game.height - size) / 2;
                    sprite.image = new phonegame.Surface(game.width, size);
                ...
                var loaded = 0,
                    len = assets.length,
                    loadFunc = function() {
                        var e = new phonegame.Event('progress');
                        e.loaded = ++loaded;
                        e.total = len;
                        game.dispatchEvent(e);
                        if (loaded === len) {
                            game.removeScene(game.loadingScene);
                            game.dispatchEvent(new phonegame.Event('load'));
                        }
                    };
                ...
                this.dispatchEvent(new phonegame.Event('load'));
            }
         ...
         *
         * Game debug mode can be set to on even if phonegame.Game.instance._debug flag is set to true.
         */
        debug: function() {
            this._debug = true;
        ...
        _tick: function() {
            var now = Date.now();
            var e = new phonegame.Event('enterframe');
            ...
            this.dispatchEvent(new phonegame.Event('exitframe'));
            this.frame++;
        },
        /**
         * Stops game.
         ...
         * Game can be reopened in phonegame.Game#start.
         */
        stop: function() {
            if (this._intervalID) {
                window.clearInterval(this._intervalID);
         ...
         * When phonegame.Game#pushScene is executed, Scene can be brought to the top of stack.
         * Frame will be updated to reflect Scene at the top of stack.
         *
         * @param {phonegame.Scene} scene Switch to new Scene.
         * @return {phonegame.Scene} New Scene.
         */
        pushScene: function(scene) {
            this._element.appendChild(scene._element);
            if (this.currentScene) {
                this.currentScene.dispatchEvent(new phonegame.Event('exit'));
            }
            this.currentScene = scene;
            this.currentScene.dispatchEvent(new phonegame.Event('enter'));
         ...
         * When phonegame.Game#popScene is activated, the Scene at the top of the stack can be pulled out.
         *
         * @return {phonegame.Scene} Ended Scene.
         */
        popScene: function() {
         ...
         *
         * phonegame.Game#popScene, phonegame.Game#pushScene are enacted simultaneously.
         *
         * @param {phonegame.Scene} scene Replace Scene.
         * @return {phonegame.Scene} New Scene.
         */
         ...
         *
         * @param {phonegame.Scene} scene Delete Scene.
         * @return {phonegame.Scene} Deleted Scene.
         */
        removeScene: function(scene) {
            if (this.currentScene === scene) {
                return this.popScene().remove();//tvt
            } else {
                var i = this._scenes.indexOf(scene);
                if (i !== -1) {
					this._scenes[i].remove();//tvt
...
// img
    phonegame.Game._loadFuncs = {};
    phonegame.Game._loadFuncs['jpg'] =
        phonegame.Game._loadFuncs['jpeg'] =
            phonegame.Game._loadFuncs['gif'] =
                phonegame.Game._loadFuncs['png'] =
                    phonegame.Game._loadFuncs['bmp'] = function(src, callback) {
                        this.assets[src] = phonegame.Surface.load(src);
                        this.assets[src].addEventListener('load', callback);
                    };
// sound
    phonegame.Game._loadFuncs['mp3'] =
        phonegame.Game._loadFuncs['aac'] =
            phonegame.Game._loadFuncs['m4a'] =
                phonegame.Game._loadFuncs['wav'] =
                    phonegame.Game._loadFuncs['ogg'] = function(src, callback, ext) {
                        this.assets[src] = phonegame.Sound.load(src, 'audio/' + ext);
                        this.assets[src].addEventListener('load', callback);
                    };
     ...
     * @return {*}
     */
    phonegame.Game.findExt = function(path) {
     ...
     * @static
     */
    phonegame.Game.instance = null;
}());

/**
 * @scope phonegame.Node.prototype
 */
phonegame.Node = phonegame.Class.create(phonegame.EventTarget, {
    /**
...
/**
 * @scope phonegame.Entity.prototype
 */
phonegame.Entity = phonegame.Class.create(phonegame.Node, {
    /**
     * A class with objects displayed on DOM. Not used directly.
     * @constructs
     * @extends phonegame.Node
     */
    initialize: function() {
        var game = phonegame.Game.instance;
        phonegame.Node.call(this);
        ...
        if (phonegame.Game.instance._debug) {
        ...
        this.addEventListener('touchstart', function() {
            ...
            var e = new phonegame.Event(this.buttonMode + 'buttondown');
            this.dispatchEvent(e);
            game.dispatchEvent(e);
        });
        this.addEventListener('touchend', function() {
            ...
            this.buttonPressed = false;
            var e = new phonegame.Event(this.buttonMode + 'buttonup');
            this.dispatchEvent(e);
            game.dispatchEvent(e);
        });
        ...
        var that = this;
        var render = function() {
            that.dispatchEvent(new phonegame.Event('render'));
        };
        ...
        if (phonegame.ENV.TOUCH_ENABLED) {
            this._element.addEventListener('touchstart', function(e) {
                ...
                for (var i = 0, len = touches.length; i < len; i++) {
                    e = new phonegame.Event('touchstart');
            ...
            this._element.addEventListener('touchmove', function(e) {
                var touches = e.touches;
                for (var i = 0, len = touches.length; i < len; i++) {
                    e = new phonegame.Event('touchmove');
                    e.identifier = touches[i].identifier;
                    e._initPosition(touches[i].pageX, touches[i].pageY);
                    that.dispatchEvent(e);
                }
            ...
            this._element.addEventListener('touchend', function(e) {
                ...
                for (var i = 0, len = touches.length; i < len; i++) {
                    e = new phonegame.Event('touchend');
                    e.identifier = touches[i].identifier;
                    e._initPosition(touches[i].pageX, touches[i].pageY);
                    that.dispatchEvent(e);
                }
...
/**
 * @scope phonegame.Sprite.prototype
 */
phonegame.Sprite = phonegame.Class.create(phonegame.Entity, {
    /**
     ...
     * @constructs
     * @extends phonegame.Entity
     */
    initialize: function(width, height) {
        phonegame.Entity.call(this);
        ...
        this.addEventListener('render', function() {
            if (this._dirty) {
				/*if(this.parentNode){
					this._rotation = this._rotation+this.parentNode._rotation;
					this._scaleX = this._scaleX+this.parentNode._scaleX-1;
					this._scaleY = this._scaleY+this.parentNode._scaleY-1;
				}*/
                var transform = [
                ...
                this._style[phonegame.ENV.VENDOR_PREFIX + 'Transform'] = transform.join('');
                this._dirty = false;
            }
        });
         ...
         * _frameSeuence に
         */
        /* tvt this.addEventListener('enterframe', function() {
        ...
        if (this._image != null) {
            ...
            if (this._image._css) {
                this._style.backgroundPosition = [
                    this._frameLeft-(frame % row | 0) * this._width, 'px ',
                    this._frameTop-(frame / row | 0) * this._height, 'px'
                ].join('');
            } else if (this._element.firstChild) {
                var style = this._element.firstChild.style;
                style.left = this._frameLeft-(frame % row | 0) * this._width + 'px';
                style.top = this._frameTop-(frame / row | 0) * this._height + 'px';
            }
        }
    }
});
/**
 * @scope phonegame.Label.prototype
 */
phonegame.Label = phonegame.Class.create(phonegame.Entity, {
    /**
     * Create Label object.
     * @constructs
     * @extends phonegame.Entity
...
(function() {
    /**
     * @scope phonegame.Map.prototype
     */
    phonegame.Map = phonegame.Class.create(phonegame.Entity, {
        /**
        ...
        initialize: function(tileWidth, tileHeight) {
            ...
            var canvas = document.createElement('canvas');
            if (phonegame.ENV.RETINA_DISPLAY && game.scale === 2) {
        ...
        image: {
            ...
            set: function(image) {
                ...
                this._image = image;
                if (phonegame.ENV.RETINA_DISPLAY && game.scale === 2) {
                    var img = new phonegame.Surface(image.width * 2, image.height * 2);
...
/**
 * @scope phonegame.Group.prototype
 */
phonegame.Group = phonegame.Class.create(phonegame.Node, {
    /**
    ...
    initialize: function() {
        ...
        [phonegame.Event.ADDED_TO_SCENE, phonegame.Event.REMOVED_FROM_SCENE]
    ...
    /**
     * Adds Node to Group.
     * @param {phonegame.Node} node Added Node.
     */
    addChild: function(node) {
        ...
        node.dispatchEvent(new phonegame.Event('added'));
        if (this.scene) {
            var e = new phonegame.Event('addedtoscene');
     ...
     * @param {phonegame.Node} node Incorporated Node.
     * @param {phonegame.Node} reference Node in position before incorporation.
     */
     ...
     * @param {phonegame.Node} node Deleted Node.
     */
    removeChild: function(node) {
        ...
        node.dispatchEvent(new phonegame.Event('removed'));
        if (this.scene) {
            var e = new phonegame.Event('removedfromscene');
            node.scene = null;
            node.dispatchEvent(e);
            if (node._element) {
...
/**
 * @scope phonegame.RGroup.prototype
 */
phonegame.RGroup = phonegame.Class.create(phonegame.Group, {
    /**
     ...
     *
     * @constructs
     * @extends phonegame.Group
     */
    initialize: function(width, height) {
        phonegame.Group.call(this);
    ...
    addChild: function(node) {
        phonegame.Group.prototype.addChild.apply(this, arguments);
...
/**
 * @scope phonegame.Scene.prototype
 */
phonegame.Scene = phonegame.Class.create(phonegame.Group, {
    /**
    ...
    initialize: function() {
        ...
        this._element.style[phonegame.ENV.VENDOR_PREFIX + 'TransformOrigin'] = '0 0';
        this._element.style[phonegame.ENV.VENDOR_PREFIX + 'Transform'] = 'scale(' + game.scale + ')';
...
(function() {
    /**
     * @scope phonegame.CanvasGroup
     */
    phonegame.CanvasGroup = phonegame.Class.create(phonegame.Group, {
        /**
         */
        initialize: function() {
            var game = phonegame.Game.instance;
            ...
            var start = [
                phonegame.Event.ENTER,
                phonegame.Event.ADDED_TO_SCENE
            ];
            var end = [
                phonegame.Event.EXIT,
                phonegame.Event.REMOVED_FROM_SCENE
            ];
    ...
    if (phonegame.widget) {
        phonegame.widget.EntityGroup.prototype.cvsRender = function(ctx) {
            if (this.background &&
    ...
    phonegame.Map.prototype.cvsRender = function(ctx) {
        var game = phonegame.Game.instance;
        ctx.save();
    ...
    phonegame.Sprite.prototype.cvsRender = function(ctx) {
    ...
    phonegame.Label.prototype.cvsRender = function(ctx) {
        if (this.text) {
    ...
    var DetectColorManager = phonegame.Class.create({
    ...
    var render = function(ctx, node) {
        ...
        if (game._debug) {
            if (node instanceof phonegame.Label || node instanceof phonegame.Sprite) {
...
/**
 * @scope phonegame.Surface.prototype
 */
phonegame.Surface = phonegame.Class.create(phonegame.EventTarget, {
    /**
    ...
    initialize: function(width, height) {
        ...
        var id = 'phonegame-surface' + game._surfaceID++;
        if (document.getCSSCanvasContext) {
            ...
            phonegame.ENV.CANVAS_DRAWING_METHODS.forEach(function(name) {
     ...
     *
     * @param {phonegame.Surface} image Surface used in drawing.
     */
    draw: function(image) {
    ...
    /**
     * Copies Surface.
     * @return {phonegame.Surface} Copied Surface.
     */
    clone: function() {
        var clone = new phonegame.Surface(this.width, this.height);
        clone.draw(this);
        return clone;
    },
    /**
 ...
 * @static
 */
phonegame.Surface.load = function(src) {
    var image = new Image();
    var surface = Object.create(phonegame.Surface.prototype, {
        context: { value: null },
        _css: { value: 'url(' + src + ')' },
        _element: { value: image }
    });
    phonegame.EventTarget.call(surface);
    image.src = src;
    ...
    image.onload = function() {
        ...
        surface.dispatchEvent(new phonegame.Event('load'));
    };
    return surface;
};
/**
 * @scope phonegame.Sound.prototype
 */
phonegame.Sound = phonegame.Class.create(phonegame.EventTarget, {
    /**
     ...
     *
     * Instances are created not via constructor but via phonegame.Sound.load.
     *
     * @constructs
     */
    initialize: function() {
    ...
    /**
     * Copy Sound.
     * @return {phonegame.Sound} Copied Sound.
     */
    clone: function() {
        var clone;
        if (this._element instanceof Audio) {
            clone = Object.create(phonegame.Sound.prototype, {
                _element: { value: this._element.cloneNode(false) },
                duration: { value: this.duration }
            });
        } else if (phonegame.ENV.USE_FLASH_SOUND) {
            return this;
        } else {
            clone = Object.create(phonegame.Sound.prototype);
        }
        phonegame.EventTarget.call(clone);
        return clone;
    },
    /**
 ...
 * @static
 */
phonegame.Sound.load = function(src, type) {
    if (type == null) {
        var ext = phonegame.Game.findExt(src);
        if (ext) {
            type = 'audio/' + ext;
    ...
    var sound = Object.create(phonegame.Sound.prototype);
    phonegame.EventTarget.call(sound);
    var audio = new Audio();
    if (!phonegame.Sound.enabledInMobileSafari &&
        phonegame.ENV.VENDOR_PREFIX === 'webkit' && phonegame.ENV.TOUCH_ENABLED) {
        window.setTimeout(function() {
            sound.dispatchEvent(new phonegame.Event('load'));
        }, 0);
    } else {
        if (!phonegame.ENV.USE_FLASH_SOUND && audio.canPlayType(type)) {
            audio.src = src;
            audio.load();
            ...
            var id = 'phonegame-audio' + phonegame.Game.instance._soundID++;
            ...
            phonegame.Game.instance._element.appendChild(embed);
            phonegame.Sound[id] = sound;
        } else {
            window.setTimeout(function() {
                sound.dispatchEvent(new phonegame.Event('load'));
            }, 0);
...
phonegame.Sound.enabledInMobileSafari = false;
